...
class CalculatorEkoView extends Widget
{
    public $message;
  ...
  <div class="panel panel-success">
    <div class="panel-heading">Расчет стоимости эко-уборки квартир и коттеджей!</div>
    <div class="panel-body">


    <div class="form-group email required hide user_basic_email">
            <?
                ...
                echo Html::tag('option','Эко-уборка',['value' => "3",'selected'=>'selected']);
    ...
    <span class='btn btn-success btn-calc col-md-12'>Посчитать</span>
    <br><br>
    <div class='ResultWrap' style='display:none;'>
      ...
      <div class='CleaningContent-3 alert alert-info' style='display:none;'>
          <span class="CalcResult col-md-12" style="font-size: 31px;margin: -6px 0px;color: #337AB7;text-align: center;padding: 5px 0px;"></span>
           <div class='snoska'>*Точную стоимость услуг Вы узнаете после выезда наших специалистов на объект оказания услуг</div>
      </div>
